<html>
	...
	{	
		...
		$.post(	"Executable.jsp",
					...
					"intervalSize":document.getElementById("intervalSize").value,
	...
	<br>
	<br>
	Please choose an interval size for MASCOT scores: <br>
	<input type="text" name="intervalSize" id="intervalSize" value="5"/> <br>
	Last interval's minimal value: <input type="text" name="max" id="max" value="100"/> <br>
